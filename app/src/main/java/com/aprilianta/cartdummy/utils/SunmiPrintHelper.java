package com.aprilianta.cartdummy.utils;
...
public class SunmiPrintHelper {
     ...
     */
    public void sendTextsToLcd(String textTop, String textMiddle, String textBottom){
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
        ...
        try {
            String[] texts = {textTop, textMiddle, textBottom};
            int[] align = {2, 1, 2};
